...
- ```--working_directory <path>```: name of the directory with results. Default: "output_paperfly_<datetime>".
...
- ```--distance_metric <hamming|levenstein>```: metric to use in mapping. Default: levenstein.
